...
CREATE TABLE `tb_order` (
  ...
  `order_mode` TINYINT(1) DEFAULT 0 COMMENT '下单模式：0-普通购买，1-拼团购买',
  `group_discount_amount` DECIMAL(10,2) DEFAULT 0.00 COMMENT '拼团折扣金额',
  `wholesale_discount_amount` DECIMAL(10,2) DEFAULT 0.00 COMMENT '批发折扣金额',
  `coupon_discount_amount` DECIMAL(10,2) DEFAULT 0.00 COMMENT '优惠券抵扣金额',
  `discount_amount` DECIMAL(10,2) DEFAULT 0.00 COMMENT '总优惠金额',
  `reward_points` INT(11) DEFAULT 0 COMMENT '购物奖励积分',
  `create_time` DATETIME DEFAULT NULL COMMENT '创建时间',
  `update_time` DATETIME DEFAULT NULL COMMENT '更新时间',
  `deleted` INT(11) DEFAULT 0 COMMENT '是否删除：0-未删除，1-已删除',
  PRIMARY KEY (`id`),
...
CREATE TABLE `tb_experience_activity` (
  ...
  `type` TINYINT(1) DEFAULT 1 COMMENT '活动类型：1-茶艺课，2-茶园参观，3-线下品鉴会，4-制茶体验，5-采摘招募，6-批发与培训',
...
CREATE TABLE `tb_user_activity_coupon` (
  ...
  `coupon_type` TINYINT(1) DEFAULT 1 COMMENT '券类型：1-茶艺课，2-茶园参观，3-线下品鉴会，4-制茶体验，5-采摘招募，6-批发与培训',
...
-- ============================================
-- 插入示例门店数据（虚构商户，仅用于演示）
-- 注意：店名与门牌为演示组合，不代表真实登记商户；道路名称参考福鼎当地常见路名
-- 经纬度：市域内分散点位（非测绘精度）
-- ============================================
...
('桐城玉龙白茶馆（南湖片店）', '桐城街道南湖片，近玉龙北路一带，白茶品鉴与零售', NULL, '福建省', '宁德市', '福鼎市', '桐城街道玉龙北路128号', 120.2178000, 27.3255000, '0593-1234567', '09:00-22:00', 1, NOW(), NOW()),
('南大路茶庄（中心广场店）', '桐山老城区南大路商圈，往来太姥大道、海口路方便', NULL, '福建省', '宁德市', '福鼎市', '桐山街道南大路88号', 120.2115000, 27.3312000, '0593-1234568', '08:30-21:30', 1, NOW(), NOW()),
('山前通和福鼎白茶体验馆', '山前街道通和路一侧，展示福鼎白茶工艺与山前片区茶事', NULL, '福建省', '宁德市', '福鼎市', '山前街道通和路256号', 120.2235000, 27.3185000, '0593-1234569', '09:00-21:00', 1, NOW(), NOW()),
('中山中路茶香居', '桐山中山中路步行街段，老城街巷氛围，茶具茶叶兼营', NULL, '福建省', '宁德市', '福鼎市', '桐山街道中山中路156号', 120.2088000, 27.3235000, '0593-1234570', '10:00-22:00', 1, NOW(), NOW()),
('扆山庆丰白毫银针行', '点头镇扆山下，庆丰街一带，主销白毫银针与点头白茶', NULL, '福建省', '宁德市', '福鼎市', '点头镇庆丰街78号', 120.1833000, 27.2322000, '0593-1234571', '09:00-20:30', 1, NOW(), NOW()),
('岐阳前岐茶韵坊', '前岐镇岐阳片，福东南路沿线，闽浙边贸与白茶集散氛围', NULL, '福建省', '宁德市', '福鼎市', '前岐镇福东南路368号', 120.3120000, 27.2880000, '0593-1234572', '09:00-21:00', 1, NOW(), NOW()),
('白琳碧丰古韵茶庄', '白琳镇碧丰西路一带，白琳工夫与福鼎白茶传统产区', NULL, '福建省', '宁德市', '福鼎市', '白琳镇碧丰西路188号', 120.1410000, 27.1720000, '0593-1234573', '08:00-20:00', 1, NOW(), NOW()),
('玉茗贯岭白茶工坊', '贯岭镇玉茗路片区，闽浙交界山区茶香，可体验品鉴', NULL, '福建省', '宁德市', '福鼎市', '贯岭镇玉茗路188号', 120.0650000, 27.3520000, '0593-1234574', '09:30-21:30', 1, NOW(), NOW()),
('星火茶语时光', '桐城星火工业园区周边，年轻化包装白茶与快饮体验', NULL, '福建省', '宁德市', '福鼎市', '桐城街道星火路99号', 120.2200000, 27.3280000, '0593-1234575', '10:00-22:00', 1, NOW(), NOW()),
('店下育贤白茶旗舰店', '店下镇育贤街一带，近镇区主街，旅游与本地客兼顾', NULL, '福建省', '宁德市', '福鼎市', '店下镇育贤街666号', 120.3380000, 27.2650000, '0593-1234576', '08:30-21:00', 1, NOW(), NOW()),
('秦川站前茶香行', '太姥山镇秦川路近动车站方向，游客与返乡客捎带白茶', NULL, '福建省', '宁德市', '福鼎市', '太姥山镇秦川路168号', 120.2520000, 27.1020000, '0593-1234577', '08:00-20:30', 1, NOW(), NOW()),
('磻溪金谷白牡丹茶庄', '磻溪镇金谷片，磻溪白茶主产区之一，白牡丹系列齐全', NULL, '福建省', '宁德市', '福鼎市', '磻溪镇金谷街112号', 120.0310000, 27.2480000, '0593-1234578', '09:00-21:00', 1, NOW(), NOW()),
('山前铁塘茶友汇', '山前街道铁塘社区一带，新城与桐山溪两岸茶客往来', NULL, '福建省', '宁德市', '福鼎市', '山前街道铁塘里288号', 120.2270000, 27.3340000, '0593-1234579', '09:00-22:00', 1, NOW(), NOW()),
('管阳中洋老茶行', '管阳镇中洋街一带，闽浙边界高山茶风味', NULL, '福建省', '宁德市', '福鼎市', '管阳镇中洋街58号', 119.9920000, 27.2580000, '0593-1234580', '08:00-19:30', 1, NOW(), NOW()),
('沙埕海滨茶艺空间', '沙埕镇海滨南路临海一侧，渔港风情与白茶伴手礼', NULL, '福建省', '宁德市', '福鼎市', '沙埕镇海滨南路188号', 120.3980000, 27.1250000, '0593-1234581', '09:00-21:30', 1, NOW(), NOW());
...
CREATE TABLE `tb_reward` (
  ...
  `coupon_discount_type` TINYINT(1) DEFAULT NULL COMMENT '优惠券规则(仅type=2)：1减20 2减30 3减50 4减80 5减5% 6减12%',
  `status` TINYINT(1) DEFAULT 1 COMMENT '状态：0-下架，1-上架',
  `sort_order` INT(11) DEFAULT 0 COMMENT '排序',
  `create_time` DATETIME DEFAULT NULL COMMENT '创建时间',
  `update_time` DATETIME DEFAULT NULL COMMENT '更新时间',
...
CREATE TABLE `tb_reward_exchange` (
  ...
  `remark` VARCHAR(500) DEFAULT NULL COMMENT '备注',
  `order_id` BIGINT(20) DEFAULT NULL COMMENT '下单使用该券抵扣时关联的订单ID',
...
-- 21. 订单评价表（整单一条评价）
-- ============================================
DROP TABLE IF EXISTS `tb_order_review`;
