...
public interface OrderService {
    ...
    /**
     * 创建订单
     * @param deliveryType 取货方式：1-线上配送，2-线下自提（唯一默认门店，无需传门店 ID）
     * @param addressId 收货地址ID（线上配送时必填）
     * @param cartIds 要结算的购物车项 id，null 或空表示整单结算（兼容旧接口）
     */
    Order createOrder(Long userId, Integer deliveryType, Long addressId, String receiverName, String receiverPhone, String receiverAddress, String remark, List<Long> cartIds, Long couponId, Integer orderMode);
